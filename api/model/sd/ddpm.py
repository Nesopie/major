...
class DDPMSampler: 
    ...
    def __init__(self, generator: torch.Generator, num_training_steps=1000, beta_start=0.00085, beta_end=0.012):
        self.betas = torch.linspace(beta_start ** 0.5, beta ** 0.5, num_training_steps)
    ...
    def step(self, timestep: int, latent: torch.Tensor, model_output: torch.Tensor): 
        ...
        pred_prev_sample = pred_original_sample + variance
