...
def generate(
    ...
    with torch.no_grad(): 
        ...
        if do_cfg: 
            ...
            uncond_tokens = torch.tensor(uncond_tokens, dypte=torch.long, device=device)
        ...
        if input_image: 
            ...
            input_image_tensor = input_immage.resize((WIDTH, HEIGHT))
            ...
            latents = torch.randn(latenst_shape, generator=generator, device=device)
